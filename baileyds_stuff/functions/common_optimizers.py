...
I do not include really any documentation here, but all of these optimizers
and learning rate schedulers can be googled, and there are quite a few that 
are already in pytorch; this was a good way for me to learn how to write 
optimizers, and so maybe it will be a useful tool to look at how to write 
simple optimizers in pytorch.
"""
