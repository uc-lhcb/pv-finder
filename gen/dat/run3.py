...
def write(pre, fnc, par):
    ...
    for i, v in enumerate(par): p[i], e[i] = v, 0
...
uzs = [-277, -252, -227, -202, -132, -62, -37, -12, 13, 38, 63, 88, 113, 138, 
        163, 188, 213, 238, 263, 325, 402, 497, 616, 661, 706, 751]
...
lzs = [-289, -264, -239, -214, -144, -74, -49, -24, 1, 26, 51, 76, 101, 126,
        151, 176, 201, 226, 251, 313, 390, 485, 604, 649, 694, 739]
...
lim = ROOT.TVectorD(2); lim[0], lim[1] = -300, 800
