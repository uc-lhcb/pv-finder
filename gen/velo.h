    ...
    class Integral {
      ...
      public:
        ...
        */
        ...
        /// Configure the tool.
        void
        config(double dvminIn, double sigmaIn, double mwIn, double tolIn, ROOT::Math::IntegrationMultiDim::Type algIn);

        /// Return the probability integral.
        double integral(double vxIn, double vyIn, double vzIn, double dvxIn, double dvyIn, double dvzIn, int halfIn);
    };
    ...
    class Distance {
      ...
      public:
        ...
        */
        ...
        /// Return the distance.
        TLorentzVector
        distance(double vxIn, double vyIn, double vzIn, double dvxIn, double dvyIn, double dvzIn, int halfIn);
    };
  ...
  public:
    ...
    */
    ...
    /*
      ...
      \param half: -/+1 for the lower/upper VELO half in x, 0 for both.
     */
    void configSensor(double xc = 0, double yc = 0, bool rel = true, int half = 0);
    ...
    */
    void configIntegral(double dvmin = 0.25,
                        double sigma = 5,
                        double width = 1,
                        double tol = 0.01,
                        ROOT::Math::IntegrationMultiDim::Type alg = ROOT::Math::IntegrationMultiDim::kADAPTIVE);
    ...
    */
    void configDistance(double dvmin = 0.25, double tol = 1e-10, int itr = 100, bool logt = false);
    ...
    /*
      ...
      \param half:        -/+1 for the lower/upper VELO half in x, 0 for both.
    */
    double integral(double vx, double vy, double vz, double dvx, double dvy, double dvz, int half);
    ...
    /*
      ...
      \param half:     -/+1 for the lower/upper VELO half in x, 0 for both.
    */
    TLorentzVector intersect(double vx, double vy, double vz, double fx, double fy, double fz, int half = 0);
    ...
    */
    TLorentzVector
    distance(double vx, double vy, double vz, double dvx = 1, double dvy = 1, double dvz = 1, int half = 0);
};
  ...
  public:
    ...
    class Integral {
      ...
      public:
        ...
        */
        ...
        /// Return the probability integral.
        double integral(double vxIn, double vyIn, double vzIn, double dvxIn, double dvyIn, double dvzIn, int methodIn);
    };
    ...
    */
    class Intersect {
      ...
      public:
        ...
        */
        ...
        TLorentzVector
        intersect(double vxIn, double vyIn, double vzIn, double fxIn, double fyIn, double fzIn, int halfIn);
    };
    ...
    class Distance {
        ...
        */
        void distance(int halfIn, int method, int dir, TLorentzVector &s, double &n, double &u);
      ...
      public:
        ...
        */
        ...
        /// Return the distance.
        TLorentzVector distance(double vxIn,
                                double vyIn,
                                double vzIn,
                                double dvxIn,
                                double dvyIn,
  ...
  public:
    ...
    */
    ...
    /*
      ...
      \param logt: flag to use a log scale in minimization.
    */
    void configIntersect(double step = 1, double tol = 1e-10, int itr = 100, bool logt = false);
    ...
    */
    void configDistance(double dvmin = 0.25,
                        double dvmax = 100,
                        double sigma = 5,
                        double step = 1,
                        double tol = 1e-2,
    ...
    /*
      ...
      \param d[vx,vy,vz]: uncertainties on the x,y,z-positions of the vertex.
    */
    double integral(double vx, double vy, double vz, double dvx, double dvy, double dvz, int method = 0);
    ...
    */
    TLorentzVector distance(double vx,
                            double vy,
                            double vz,
                            double dvx = 1,
                            double dvy = 1,
  ...
  public:
    ...
    */
    ...
    /*
      ...
      \param d[vx,vy,vz]: x,y,z-uncertainties of the vertex position.
    */
    double distance(double vx, double vy, double vz, double dvx, double dvy, double dvz);
    ...
    */
    bool miss(double vx, double vy, double vz, double fx, double fy, double fz, double mz);
