...
class Loss(torch.nn.Module):
    ...
    def forward(self, x, y):
        ...
        if self.debug:
            print(
                "ave_beta, ave_chisq, 0.02*ave_beta + 0.98*ave_chisq = ",
                ave_beta,
                ave_chisq,
                0.02 * ave_beta + 0.98 * ave_chisq,
            )
            print(
                "ave_chi4, 0.02*ave_beta + 0.98*ave_chisq + ave_chi4 = ",
                ave_chi4,
                0.02 * ave_beta + 0.98 * ave_chisq + ave_chi4,
            )
