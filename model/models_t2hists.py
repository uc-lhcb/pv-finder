...
class TracksToHists_A(nn.Module):
    ...
    def __init__(
        ...
        assert (
            self.hist_conv1.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' hist_conv."
        ...
        assert (
            self.hist_conv2.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' hist_conv."
        ...
        assert (
            self.hist_conv3.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' hist_conv."
        ...
        assert (
            self.hist_conv4.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' hist_conv."
        ...
        assert (
            self.hist_conv5.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' hist_conv."
        ...
        self.hist_fc1 = nn.Linear(
            in_features=4000 * self.hist_conv5.out_channels, out_features=4000
        )
...
class TracksToHists_C(nn.Module):
    ...
    def __init__(
        ...
        assert (
            self.hist_finalFilter.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' conv."
