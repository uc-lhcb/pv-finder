...
class SimpleCNN3Layer_A(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1=nn.Conv1d(1, self.nChan_out_layer1, kernel_size_layer1, stride_layer1, padding_layer1)
        ...
        self.conv2=nn.Conv1d(self.nChan_out_layer1, self.nChan_out_layer2, kernel_size_layer2, stride_layer2, padding_layer2)        
        ...
        self.conv3=nn.Conv1d(self.nChan_out_layer2, self.nChan_out_layer3, kernel_size_layer3, stride_layer3, padding_layer3) 
