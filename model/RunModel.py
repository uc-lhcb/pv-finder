...
def main(n_epochs, name, data, batch, learning_rate, model, output):
    ...
    for results in trainNet(model, dataset_train, dataset_val,
        ...
        progress.set_description(f" Current loss {results.cost[-1]:.5f} (val {results.val[-1]:.5f})")
