...
class TracksToKDE_A(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = nn.Linear(in_features=6, out_features=12, bias=True)
        self.layer2 = nn.Linear(
            in_features=self.layer1.out_features, out_features=15, bias=True
        )
        self.layer3 = nn.Linear(
            in_features=self.layer2.out_features, out_features=4000, bias=True
        )
...
class TracksToKDE_B(nn.Module):
    ...
    def __init__(self, nOut1=12, nOut2=15):
        ...
        self.layer1 = nn.Linear(in_features=6, out_features=self.nOut1, bias=True)
        self.layer2 = nn.Linear(
            in_features=self.layer1.out_features, out_features=self.nOut2, bias=True
        )
        self.layer3 = nn.Linear(
            in_features=self.layer2.out_features, out_features=4000, bias=True
        )
...
class TracksToKDE_D(nn.Module):
    ...
    def __init__(self, nOut1=12, nOut2=15, nOut3=25):
        ...
        self.layer3 = nn.Linear(
            in_features=self.layer2.out_features, out_features=self.nOut3, bias=True
        )
        self.layer4 = nn.Linear(
            in_features=self.layer3.out_features, out_features=4000, bias=True
        )
...
class TracksToKDE_Ellipsoids_SevenLayerCake(nn.Module):
    ...
    def __init__(self, nOut1=25, nOut2=25, nOut3=25, nOut4=25, nOut5=25, nOut6=50):
        super().__init__()
        ...
        self.layer4a = nn.Linear(
            in_features=self.layer3.out_features, out_features=self.nOut4, bias=True
        )
        self.layer5a = nn.Linear(
            in_features=self.layer4a.out_features, out_features=self.nOut5, bias=True
        )
        self.layer6a = nn.Linear(
            in_features=self.layer5a.out_features, out_features=self.nOut6, bias=True
        )
        self.layer7a = nn.Linear(
            in_features=self.layer6a.out_features, out_features=4000, bias=True
        )
...
class TracksToKDE_Ellipsoids_DirtyDozen(nn.Module):
    ...
    def __init__(
        ...
        self.layer5 = nn.Linear(
            in_features=self.layer4.out_features, out_features=self.nOut5, bias=True
        )
        self.layer6 = nn.Linear(
            in_features=self.layer5.out_features, out_features=self.nOut6, bias=True
        )
        self.layer7 = nn.Linear(
            in_features=self.layer6.out_features, out_features=self.nOut7, bias=True
        )
        self.layer8 = nn.Linear(
            in_features=self.layer7.out_features, out_features=self.nOut8, bias=True
        )
        self.layer9 = nn.Linear(
            in_features=self.layer8.out_features, out_features=self.nOut9, bias=True
        )
        self.layer10 = nn.Linear(
            in_features=self.layer9.out_features, out_features=self.nOut10, bias=True
        )
        self.layer11 = nn.Linear(
            in_features=self.layer10.out_features, out_features=self.nOut11, bias=True
        )
        self.layer12 = nn.Linear(
            in_features=self.layer11.out_features, out_features=4000, bias=True
        )
...
class TracksToKDE_Ellipsoids_Skipper(nn.Module):
    ...
    def __init__(
        ...
        ## used.
        self.layer4 = nn.Linear(
            in_features=self.layer3.out_features + 9, out_features=self.nOut4, bias=True
        )
        self.layer5 = nn.Linear(
            in_features=self.layer4.out_features, out_features=self.nOut5, bias=True
        )
        ...
        self.layer8 = nn.Linear(
            in_features=self.layer7.out_features + 9, out_features=self.nOut8, bias=True
        )
        self.layer9 = nn.Linear(
            in_features=self.layer8.out_features, out_features=self.nOut9, bias=True
        )
        ...
        self.layer12 = nn.Linear(
            in_features=self.layer11.out_features + 9, out_features=4000, bias=True
        )
...
class TracksToKDE_Ellipsoids_DDplusCNN(nn.Module):
    ...
    def __init__(
        ...
        assert (
            self.finalFilterCNN.kernel_size[0] % 2 == 1
        ), "Kernel size should be odd for 'same' conv."
