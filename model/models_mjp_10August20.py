...
9. SimpleCNN5Layer, TwoFeature_CNN6Layer_A, and All_CNN6Layer_A are intermediate models to obtain well-trained models to use for the perturbative model.
'''
...
class TwoFeatures_CNN6Layer_A(nn.Module):
    '''
    This is used to pretrain the (x,y) feature set
    '''
    def __init__(self):
        super(TwoFeatures_CNN6Layer_A, self).__init__()
...
class Perturb_3F_All_CNN6Layer_A(nn.Module):
    def __init__(self):
        super(Perturb_3F_All_CNN6Layer_A, self).__init__()
        ##
    ...
    def forward(self, neuronValues):
        ...
        x1 = neuronValues[:, 1:3, :]  ## picks out the 1 & 2 feature sets, x & y
...
1. Element-wise addition used instead of concatenation before final layer
'''
